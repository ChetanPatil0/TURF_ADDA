...
router.get(
  '/my',
  authCheck,
  authorizeRoles('owner', 'admin', 'superadmin','staff'),
  getMyTurfs
);
...
// Get turfs for discovery (public)
router.get(
  '/discover',
  authCheck,
  getDiscoverTurfs
...
// Soft delete 
router.delete('/:id', authCheck, deleteTurf);

// Hard delete - only superadmin
router.delete('/:id/hard', authCheck, authorizeRoles('superadmin'), hardDeleteTurf);
...
// Get a single turf by identifier 
router.get('/:identifier', authCheck, getTurf);
