...
import { RiAdminLine, RiGroupLine, RiShieldCheckLine } from 'react-icons/ri';
...
export default function Sidebar({
  ...
  // Player menu - flat paths
  const playerMenu = [
    { label: 'Home', icon: <FiHome />, path: '/dashboard' },
    { label: 'Find Turfs', icon: <FiSearch />, path: '/find-turfs' },
    { label: 'My Bookings', icon: <FiCalendar />, path: '/bookings' },
    { label: 'Profile', icon: <FiUser />, path: '/profile' },
  ];

  // Owner menu - flat paths
  const ownerMenu = [
    { label: 'Dashboard', icon: <FiHome />, path: '/dashboard' },
    { label: 'My Turfs', icon: <MdOutlineSportsSoccer />, path: '/turfs' },
    { label: 'Add Turf', icon: <MdAddCircleOutline />, path: '/turfs/add-turf' },
    { label: 'Bookings', icon: <FiCalendar />, path: '/owner-bookings' },
    { label: 'Revenue', icon: <MdAttachMoney />, path: '/revenue' },
    { label: 'Profile', icon: <FiUser />, path: '/profile' },
  ];

  // Admin menu - flat paths
  const adminMenu = [
    { label: 'Dashboard', icon: <FiHome />, path: '/dashboard' },
    { label: 'Users', icon: <RiGroupLine />, path: '/users' },
    { label: 'Pending Verifications', icon: <RiShieldCheckLine />, path: '/turfs/pending' }, 
    { label: 'Profile', icon: <FiUser />, path: '/profile' },
  ];
