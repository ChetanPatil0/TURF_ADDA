...
const handleRejectConfirm = async (reason) => {
  ...
  try {
    await verifyTurf(id, false, reason.trim());
    ...
    showMessage({
      ...
      message:
        ...
        'Failed to reject turf. Please try again.',
    });
  } finally {
    setActionLoading(false);
  }
  ...
  if (!turf) return (
    <div className="py-24 px-5 text-center text-[var(--color-text-secondary)]">
      ...
      <button onClick={() => navigate('/turfs/pending')}>Back to list</button>
    </div>
  );
    ...
    <div className="bg-[var(--color-bg-default)] min-h-screen">
      ...
      <div className="sticky top-0 bg-[var(--color-bg-paper)] border-b border-[var(--color-divider)] px-5 py-2 z-[1000] flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-4">
          <button
            onClick={() => navigate('/turfs/pending')}
      ...
      <div className="max-w-6xl mx-auto p-6">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-6 items-start">
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* Moved up – now appears right after Turf Information */}
                ...
                <div>
                  ...
                  {bank.passbookImage ? (
                    ...
                    >
                      ...
                      View Passbook / Cheque
                    </a>
                  ) : (
                    <EmptyBox text="No passbook or cheque document uploaded" />
                  )}
                </div>
              </div>
            </Section>
